                  ...
                  <div className="bg-background rounded-2xl shadow-xl p-6 max-w-sm mx-auto">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                        ...
                        <span className="px-2 py-1 bg-rose-100 text-rose-700 rounded-md text-xs font-medium">
                          위험
                        </span>
                      </div>
                    </div>
              ...
              {[
                {
                  ...
                  role: "제조업 대표",
                  content:
                    "급하게 인력이 필요할 때 정말 유용해요. 검증된 인력만 오니까 걱정 없이 일을 맡길 수 있습니다.",
                  rating: 5,
                },
                {
                  name: "이민호",
                  role: "구직자 (A등급)",
                  content:
                    "당일 정산이 정말 좋아요! 일한 만큼 바로 받으니까 동기부여도 되고, 신뢰 등급 올리는 재미도 있어요.",
                  rating: 5,
                },
                {
                  name: "박공장장",
                  role: "식품공장 관리자",
                  content:
                    "Safety Zone 기능 덕분에 4대보험 관리가 훨씬 편해졌어요. 리스크 없이 운영할 수 있습니다.",
                  rating: 5,
                },
              ].map((review, i) => (
                <Card
                  key={i}
                  className="bg-background border border-border/80 rounded-3xl overflow-hidden"
                >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
              {[
                ...
                <div
                  key={stat.label}
                  className="text-center p-6 md:p-8 bg-slate-50 rounded-3xl"
                >
              ...
              {[
                {
                  icon: Clock,
                  title: "실시간 매칭",
                  desc: "급한 인력도 30분 내 매칭",
                  color: "blue",
                },
                {
                  icon: FileText,
                  title: "무료 근로계약서",
                  desc: "법적 효력있는 전자계약서 무료 제공",
                  color: "emerald",
                },
                {
                  icon: Zap,
                  title: "GPS 출퇴근",
                  desc: "위치 기반 자동 출퇴근 체크",
                  color: "amber",
                },
                {
                  icon: Shield,
                  title: "보험 관리",
                  desc: "4대보험 자동 관리 및 알림",
                  color: "rose",
                },
                {
                  icon: Star,
                  title: "보상 시스템",
                  desc: "연속 근무 시 추가 보너스 지급",
                  color: "purple",
                },
                {
                  icon: Users,
                  title: "단골 시스템",
                  desc: "자주 찾는 인력/사업장 우선 매칭",
                  color: "cyan",
                },
              ].map((feature) => (
                <Card
                  key={feature.title}
                  className="bg-background border border-border/80 rounded-3xl hover:shadow-lg transition-shadow"
                >
                  <CardContent className="p-6">
                    <div
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/auth/login?callbackUrl=/employer">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-white text-blue-600 hover:bg-blue-50 font-semibold px-8 rounded-xl h-14 text-base"
                >
              ...
              <Link href={workerHref}>
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-transparent border-2 border-white text-white hover:bg-white/20 hover:scale-105 hover:shadow-lg active:scale-95 transition-all duration-200 font-semibold px-8 rounded-xl h-14 text-base"
                >
